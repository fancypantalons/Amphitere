This project is Amphitere Classic, a modernized Android port of NetHack 3.6.7, following a "thick native, thin wrapper" architectural model.
...
```bash
adb shell am start -n ca.b_ark.amphitere.classic/com.tbd.forkfront.ForkFront
```
